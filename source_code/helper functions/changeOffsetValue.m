function newValue = changeOffsetValue(currValue)
...
%              Empty if No is selected or the dialog is canceled.
    ...
    questionLabel = uilabel(dlg, ...
                            'Text', strcat("Do you want to change the offset value? (currently ", num2str(currValue),")"), ...
                            'Position', [100 dlgHeight-80 500 30], ...
                            'FontSize', 14, ...
    ...
    yesButton = uibutton(dlg, 'push', ...
                         'Text', 'Yes', ...
                         'Position',[440 dlgHeight-80 50 30], ...
                         'ButtonPushedFcn', @(btn,event) onYes());

    % No Button
    noButton = uibutton(dlg, 'push', ...
                        'Text', 'No', ...
                        'Position', [500 dlgHeight-80 50 30], ...
